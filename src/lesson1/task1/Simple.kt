...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =
    ((sagenes * 48) + ((arshins.toDouble() / 3) * 48) + vershoks) * 4.445 / 100
...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
    //val result: Double = (deg * 3600 + min * 60 + sec) * 4.84814e-6  206264.806
    val result: Double = (deg * 3600 + min * 60 + sec).toDouble() / ((3600 * 180).toDouble() / PI)
    //println("res: $result")
    return result
}
